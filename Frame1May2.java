...
//---------------------------------------CHECKOUT BUTTONS TAB ITEMS FROM HERE--------------------------------------------------------------------------------
		...
		check.setBounds(144, 62, 150, 18);
		
		comboBox_3 = new JComboBox(roomr);
		comboBox_3.setBounds(310, 61, 57, 22);
...
if(a.getSource() == bill)
{
	...
	billframe b = new billframe(cust,room101,room102,room201,room202,room301,room302);
	b.setBounds(80,0,878,768);
	b.setVisible(true);
	b.setTitle("Bill");
...
JLabel outbill,outbill_1,outbill_2,outbill_3,outbill_4,outbill_5,outbill_6,outbill_7,outbill_8,outbill_9,outbill_10,outbill_11,outbill_12,outbill_13,outbill_14,outbill_15,outbill_16,outbill_17,outbill_18,outbill_19;
JButton outbutton;
JTable table_3;
...
billframe(String cust[][],String room101[][],String room102[][],String room201[][],String room202[][],String room301[][],String room302[][])
{
		//for(int i=0;i<6;i++){
		//	for(int j=0;j<7;j++){
		//		this.cust[i][j] = cust[i][j];
		//	}
		//}
		//for(int l=0;l<4;l++){
		//	for(int k=0;k<20;k++){
		//		this.room101[l][k] = room101[l][k];
		//		this.room102[l][k] = room102[l][k];
		//		this.room201[l][k] = room201[l][k];
		//		this.room202[l][k] = room202[l][k];
		//		this.room301[l][k] = room301[l][k];
		//		this.room302[l][k] = room302[l][k];
		//	}
		//}
		...
		outbill.setFont(new Font("Berlin Sans FB Demi", Font.BOLD, 22));
		this.add(outbill);
		
		outbill_1 = new JLabel("HOTEL RADDISON");
		outbill_1.setBounds(298, 23, 260, 63);
		outbill_1.setFont(new Font("Berlin Sans FB Demi", Font.BOLD, 28));
		this.add(outbill_1);
		
		outbill_2 = new JLabel("Name:");
		outbill_2.setBounds(89, 141, 77, 25);
		outbill_2.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 16));
		this.add(outbill_2);
		
		outbill_3 = new JLabel("New label");
		outbill_3.setBounds(264, 141, 126, 25);
		outbill_3.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 16));
		this.add(outbill_3);
		
		outbill_4 = new JLabel("Room No.:");
		outbill_4.setBounds(521, 144, 98, 18);
		outbill_4.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 16));
		this.add(outbill_4);
		
		outbill_6 = new JLabel("1011");
		outbill_6.setBounds(674, 144, 46, 18);
		outbill_6.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 16));
		this.add(outbill_6);
		
		outbill_5 = new JLabel("No of Occupants   :");
		outbill_5.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 16));
		outbill_5.setBounds(89, 193, 135, 18);
		this.add(outbill_5);
		
		outbill_7 = new JLabel("23");
		outbill_7.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 16));
		outbill_7.setBounds(264, 193, 55, 18);
		this.add(outbill_7);
		
		outbill_8 = new JLabel("Room Type   :");
		outbill_8.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 16));
		outbill_8.setBounds(521, 190, 98, 25);
		this.add(outbill_8);
		
		outbill_9 = new JLabel("Deluxe");
		outbill_9.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 16));
		outbill_9.setBounds(674, 193, 77, 18);
		this.add(outbill_9);
		
		table_3 = new JTable(serout,serprice);
		table_3.setBounds(59, 271, 255, 352);
		this.add(table_3);
		
		outbill_10 = new JLabel("Services");
		outbill_10.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 16));
		outbill_10.setBounds(60, 245, 110, 25);
		this.add(outbill_10);
		
		outbill_11 = new JLabel("Price");
		outbill_11.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 16));
		outbill_11.setBounds(190, 245, 46, 25);
		this.add(outbill_11);
		
		outbutton = new JButton("DONE");
		outbutton.setFont(new Font("Tahoma", Font.PLAIN, 20));
		outbutton.setBounds(332, 661, 160, 35);
		outbutton.addActionListener(this);
		this.add(outbutton);
		
		outbill_12 = new JLabel("Room Cost   :   ");
		outbill_12.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 16));
		outbill_12.setBounds(458, 304, 115, 25);
		this.add(outbill_12);
		
		outbill_13 = new JLabel("New label");
		outbill_13.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 16));
		outbill_13.setBounds(632, 304, 77, 25);
		this.add(outbill_13);
		
		outbill_14 = new JLabel("Services   :");
		outbill_14.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 16));
		outbill_14.setBounds(458, 369, 98, 25);
		this.add(outbill_14);
		
		outbill_15 = new JLabel("New label");
		outbill_15.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 16));
		outbill_15.setBounds(632, 369, 77, 25);
		this.add(outbill_15);
		
		outbill_16 = new JLabel("Discount   :");
		outbill_16.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 16));
		outbill_16.setBounds(458, 434, 77, 25);
		this.add(outbill_16);
		
		outbill_17 = new JLabel("New label");
		outbill_17.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 16));
		outbill_17.setBounds(632, 436, 77, 25);
		this.add(outbill_17);
		
		outbill_18 = new JLabel("TOTAL   :");
		outbill_18.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 20));
		outbill_18.setBounds(458, 510, 98, 25);
		this.add(outbill_18);
		
		outbill_19 = new JLabel("2320");
		outbill_19.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 22));
		outbill_19.setBounds(632, 510, 88, 25);
		this.add(outbill_19);
